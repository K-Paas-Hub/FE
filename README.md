...
K-PaaS 활용 디지털 사회혁신 서비스 개발 공모전 - Kareer 프로젝트
...
Kareer는 외국인 근로자들이 한국에서 안전하고 공정하게 일할 수 있도록 돕는 디지털 플랫폼입니다. AI 기술을 활용하여 근로계약서 검토, 필요 서류 안내, 면접 준비를 지원합니다.
